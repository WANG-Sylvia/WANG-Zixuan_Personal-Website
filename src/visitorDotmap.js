 (function() {
        ...
        function updateMap(year) {
            // Filter places based on the selected year
            const filteredPlaces = places.filter(d => d.year <= year);

            // Remove existing dots and labels
        ...
        d3.json("https://cdn.jsdelivr.net/npm/world-atlas@2/countries-110m.json")
            .then(data => {
                ...
                // Add event listener for the year selector
            ...
            const legend = d3.select("#legend").append("svg")
                .attr("width", 200)  // Adjust width to fit legend content
                .attr("height", 150);
